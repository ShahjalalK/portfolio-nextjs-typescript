  ...
  return (
    <div className="bg-primary px-3 py-2 shadow-2xl shadow-secoundary flex items-center space-x-2 border-b border-b-secoundary/30 sticky top-0 left-0 w-full right-0 ">
            <div className="w-9 h-9 relative object-cover ">
                    <Image src="/profile2.webp" width={50} height={50} alt="me" className="w-9 h-9 object-cover z-10 overflow-hidden border border-secoundary/50 rounded-full" />   
            ...
            <h1 className="text-lg font-bold text-white/90 line-clamp-1" >Shahjalal Khan</h1>
